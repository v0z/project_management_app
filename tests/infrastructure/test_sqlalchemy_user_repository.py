...
def test_get_by_id():
    ...
    mock_orm_user = UserORM(id=test_user_id, username="testuser", email="a@a.com", password_hash="hashed_password")
    ...
    expected_user = DomainUser(id=test_user_id, username="testuser", email="a@a.com", password_hash="hashed_password")
    # Assert the result
