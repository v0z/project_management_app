...
def project_service_provider(
    project_repo=Depends(project_repository_provider), storage=Depends(document_storage_provider)
):
    """Dependency provider for ProjectService"""
    return ProjectService(project_repo, storage=storage)


def document_service_provider(
    document_repo=Depends(document_repository_provider), storage=Depends(document_storage_provider)
):
    """Dependency provider for DocumentService"""
    return DocumentService(document_repo, storage=storage)
